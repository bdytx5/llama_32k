...
def train():
    ...
    training_args.run_name="ft_with_longLora_rp"  # name of the W&B run (optional)
    training_args.logging_steps=10  # how often to log to W&B    
    ...
    training_args = TrainingArguments(
        ...
        deepspeed="./ds_configs/stage2.json"  # Add this line for DeepSpeed
    )
    ...
    # Collect indices of examples that should be kept
    indices_to_keep = []
    for i, example in enumerate(dataset['train']):
        if len(example['text']) <= 300000:  
