...
def evaluate(model, data, batch_size, device, seq_length, run_name, sliding_window=256, use_cache=False):
    # Initialize wandb
    wandb.init(project='long_lora_eval', name=run_name)
    ...
    wandb.log({"val_acc": stats['val_acc'], "val_loss": stats['val_loss'], "val_perplexity": stats['val_perplexity']})
